...
Mau info detail produk mana, Kak? Tinggal ketik nama produknya aja ya! 😊`;
    ...
    if (lowerMsg.includes('spotify')) {
      const followUps = [
        "Maaf Kak, untuk saat ini Spotify belum tersedia di Vylozzone. Produk music streaming yang ada: YouTube Premium (include YouTube Music). Mau info YouTube Premium?",
        "Wah, Spotify belum ada nih Kak di Vylozzone. Tapi ada YouTube Premium yang include YouTube Music juga lho! Mau coba lihat harganya?",
        "Spotify belum tersedia ya Kak. Alternatifnya ada YouTube Premium yang fiturnya mirip-mirip. Tertarik mau lihat?"
      ];
    ...
    if (lowerMsg.includes('canva')) {
      const followUps = [
        "Maaf Kak, untuk saat ini Canva belum tersedia. Alternatif design apps yang ada: CapCut Pro untuk video editing. Mau info CapCut Pro?",
        "Canva belum ada nih Kak. Tapi ada CapCut Pro yang bisa buat editing video dan design juga. Mau lihat harganya?",
        "Untuk design tools, saat ini ada CapCut Pro yang cukup lengkap fiturnya. Tertarik mau coba lihat paket-paketnya?"
      ];
      return followUps[Math.floor(Math.random() * followUps.length)];
    }
