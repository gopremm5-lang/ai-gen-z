...
async function getProductInfo(productName, infoType = 'full') {
  try {
    ...
    // Untuk query harga atau info lengkap, return data mentah dengan sedikit formatting
    if (['harga', 'price', 'paket', 'full', 'lengkap'].includes(infoType.toLowerCase())) {
      ...
      // Tambahkan closing question yang sederhana
      const closingQuestion = `\nAda yang ingin ditanyakan lagi tentang ${productName}, Kak? 😊`;
      
      return cleanedData + closingQuestion;
    }
