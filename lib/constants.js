...
// Only products that actually have data files
const PRODUCT_KEYWORDS = [
    'netflix', 'disney', 'youtube', 'iqiyi', 'viu', 'wetv', 'vision+', 'vidio', 
    'prime', 'hbo', 'bstation', 'alightmotion', 'chatgpt', 'capcut', 'hbomax', 'lok-lok'
];

// Products mentioned but not available (for proper handling)
const UNAVAILABLE_PRODUCTS = [
    'spotify', 'canva', 'remini', 'picsart'
];
